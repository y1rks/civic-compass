...
//   各省委員会   定型10-24% … 議員差が大きい（河野3.4% / 斉藤23.9%）
...
// （田村智子の公式サイトでは45件中35件に「○国務大臣（田村憲久君）」等が混入していた。
//   田村憲久は自民の元厚労相で、同姓の別人。）
...
function webDocToRecords(doc, politician, index) {
  // URL に日付が入っていれば発言日として使う（河野太郎の政策ブログなど）
